              ...
              <div className="flex flex-col items-center md:items-start gap-4">
                <div className="flex items-center gap-3">
                  <button
                    ...
                    className="group h-14 px-4 flex items-center gap-2.5 rounded-xl bg-black border border-white/90 transition-all duration-300 hover:border-[hsl(var(--neon-toxic))] hover:shadow-[0_0_24px_hsl(var(--neon-toxic)/0.3)] hover:-translate-y-0.5"
                  >
                    ...
                    <div className="text-left leading-tight">
                      <div className="text-[10px] text-white/90 font-normal">Download on the</div>
                      <div className="text-lg font-semibold tracking-tight text-white -mt-0.5 transition-colors group-hover:text-[hsl(var(--neon-toxic))]">App Store</div>
                    </div>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <div className="text-left leading-tight">
                      <div className="text-[10px] uppercase tracking-wider text-white/90 font-normal">Get it on</div>
                      <div className="text-lg font-semibold tracking-tight text-white -mt-0.5 transition-colors group-hover:text-[hsl(var(--neon-toxic))]">Google Play</div>
                    </div>
                  </button>
                </div>
