...
import { 
  ArrowRight, ArrowLeft, Target, Sparkles, Globe, 
  Flame, Dumbbell, Brain, Heart, DollarSign, Moon, Coffee, Cigarette,
  Check, Zap
} from "lucide-react";
...
const Onboarding = () => {
  ...
  const { startTrial, completeOnboarding } = useSubscription();
            ...
            <div className="space-y-6 animate-in fade-in duration-500">
              ...
              <div className="flex gap-3">
                ...
                <Button 
                  onClick={handleNext} 
                  className="flex-1"
                  disabled={selectedIdentity.length === 0}
                >
                  Continue
                  <ArrowRight className="h-4 w-4 ml-2" />
                </Button>
